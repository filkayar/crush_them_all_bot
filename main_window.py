...
class BotFrame(wx.Frame):
    ...
    def __init__(self, parent):
        wx.Frame.__init__(
            self, parent, id=wx.ID_ANY, title=wx.EmptyString, pos=wx.DefaultPosition,
            size=wx.Size(-1, -1),
            style=wx.CAPTION | wx.CLOSE_BOX | wx.MAXIMIZE_BOX | wx.MINIMIZE_BOX | wx.SYSTEM_MENU | wx.CLIP_CHILDREN
        )
        ...
        self.m_staticText1 = wx.StaticText(self, wx.ID_ANY, u"- Мин. и макс. радиус контуров перекрестий (пикс.)",
                                           wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_staticText1.Wrap(-1)

        setting_values_container.Add(self.m_staticText1, wx.GBPosition(0, 1), wx.GBSpan(1, 1), wx.ALL, 5)

        self.m_staticText2 = wx.StaticText(self, wx.ID_ANY, u"- Световой порог разграничения цвета (0 - 255)",
                                           wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_staticText2.Wrap(-1)

        setting_values_container.Add(self.m_staticText2, wx.GBPosition(2, 1), wx.GBSpan(1, 1), wx.ALL, 5)

        self.m_staticText3 = wx.StaticText(self, wx.ID_ANY, u"- Точность поиска объектов (%)", wx.DefaultPosition,
                                           wx.DefaultSize, 0)
        ...
        self.m_staticText5 = wx.StaticText(
            self, wx.ID_ANY,
            u"- Задержка после начала просмотра рекламы, до начала поиска \nвыхода из "
            u"неё (с.)",
            wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_staticText6 = wx.StaticText(
            self, wx.ID_ANY,
            u"- Таймаут внештатной ситуации, промежуток между запуском рекламы \n"
            u"и текущим моментом, пока реклама не закончилась, по истечении которого \n"
            u"необходимо перезапускать приложение (с.)",
            wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_staticText6.Wrap(-1)

        setting_values_container.Add(self.m_staticText6, wx.GBPosition(4, 1), wx.GBSpan(1, 1), wx.ALL, 5)

        self.m_staticText61 = wx.StaticText(self, wx.ID_ANY,
                                            u"- Время ожидания запуска приложения от иконки до загрузки (с.)",
                                            wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_staticText61.Wrap(-1)

        setting_values_container.Add(self.m_staticText61, wx.GBPosition(5, 1), wx.GBSpan(1, 1), wx.ALL, 5)

        self.m_staticText611 = wx.StaticText(self, wx.ID_ANY,
                                             u" - Временной отрезок бездействия до перехода в спящий режим (с.)",
                                             wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_staticText6111 = wx.StaticText(
            self, wx.ID_ANY,
            u"- Выполнять нажатие кнопки \"назад\" при попытке \nпоиска выхода из "
            u"рекламы",
            wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.contour_size_min = wx.SpinCtrl(self, wx.ID_ANY, u"0", wx.DefaultPosition, wx.Size(50, -1),
                                            wx.SP_ARROW_KEYS, 0, 1000, 0)
        contour_size.Add(self.contour_size_min, 1, wx.ALL, 5)

        self.contour_size_max = wx.SpinCtrl(self, wx.ID_ANY, u"0", wx.DefaultPosition, wx.Size(50, -1),
                                            wx.SP_ARROW_KEYS, 0, 1000, 0)
        ...
        self.precision = wx.SpinCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(110, -1),
                                     wx.SP_ARROW_KEYS, 0, 100, 0)
        setting_values_container.Add(self.precision, wx.GBPosition(1, 0), wx.GBSpan(1, 1), wx.ALL, 5)

        self.wb_lvl = wx.SpinCtrl(self, wx.ID_ANY, u"0", wx.DefaultPosition, wx.Size(110, -1), wx.SP_ARROW_KEYS, 0, 255,
                                  0)
        setting_values_container.Add(self.wb_lvl, wx.GBPosition(2, 0), wx.GBSpan(1, 1), wx.ALL, 5)

        self.ad_time = wx.SpinCtrl(self, wx.ID_ANY, u"0", wx.DefaultPosition, wx.Size(110, -1), wx.SP_ARROW_KEYS, 0,
                                   100000, 29)
        setting_values_container.Add(self.ad_time, wx.GBPosition(3, 0), wx.GBSpan(1, 1), wx.ALL, 5)

        self.error_time = wx.SpinCtrl(self, wx.ID_ANY, u"0", wx.DefaultPosition, wx.Size(110, -1), wx.SP_ARROW_KEYS, 0,
                                      100000, 180)
        setting_values_container.Add(self.error_time, wx.GBPosition(4, 0), wx.GBSpan(1, 1), wx.ALL, 5)

        self.reboot_time = wx.SpinCtrl(self, wx.ID_ANY, u"0", wx.DefaultPosition, wx.Size(110, -1), wx.SP_ARROW_KEYS, 0,
                                       100000, 0)
        setting_values_container.Add(self.reboot_time, wx.GBPosition(5, 0), wx.GBSpan(1, 1), wx.ALL, 5)

        self.sleep_time = wx.SpinCtrl(self, wx.ID_ANY, u"0", wx.DefaultPosition, wx.Size(110, -1), wx.SP_ARROW_KEYS, 0,
                                      100000, 0)
        ...
        setting_values_container.Add(self.is_click_back, wx.GBPosition(7, 0), wx.GBSpan(1, 1), wx.ALIGN_RIGHT | wx.ALL,
                                     5)

        self.precision_image = wx.SpinCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(110, -1),
                                           wx.SP_ARROW_KEYS, 0, 100, 0)
        setting_values_container.Add(self.precision_image, wx.GBPosition(8, 0), wx.GBSpan(1, 1), wx.ALL, 5)

        self.m_staticText61111 = wx.StaticText(self, wx.ID_ANY,
                                               u"- Точность сравнения изображений для черного списка (%)",
                                               wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.path_cat_screen = wx.DirPickerCtrl(self, wx.ID_ANY, wx.EmptyString, u"Select a folder", wx.DefaultPosition,
                                                wx.DefaultSize, wx.DIRP_DEFAULT_STYLE)
        path_cat_screen_block.Add(self.path_cat_screen, 1, wx.ALIGN_CENTER | wx.ALL, 5)

        self.m_staticText26 = wx.StaticText(self, wx.ID_ANY, u"Каталог скриншотов", wx.DefaultPosition, wx.DefaultSize,
                                            0)
        ...
        self.path_chest = wx.FilePickerCtrl(self, wx.ID_ANY, wx.EmptyString, u"Select a file", u"*.*",
        ...
        self.path_tree_chest = wx.FilePickerCtrl(self, wx.ID_ANY, wx.EmptyString, u"Select a file", u"*.*",
                                                 wx.DefaultPosition, wx.DefaultSize, wx.FLP_DEFAULT_STYLE)
        path_tree_chest_block.Add(self.path_tree_chest, 1, wx.ALIGN_CENTER | wx.ALL, 5)

        self.m_staticText271 = wx.StaticText(self, wx.ID_ANY, u"Деревянный сундук", wx.DefaultPosition, wx.Size(-1, -1),
                                             0)
        ...
        self.path_check = wx.FilePickerCtrl(self, wx.ID_ANY, wx.EmptyString, u"Select a file", u"*.*",
                                            wx.DefaultPosition, wx.DefaultSize, wx.FLP_DEFAULT_STYLE)
        ...
        self.path_end = wx.FilePickerCtrl(self, wx.ID_ANY, wx.EmptyString, u"Select a file", u"*.*", wx.DefaultPosition,
                                          wx.DefaultSize, wx.FLP_DEFAULT_STYLE)
        path_end_block.Add(self.path_end, 1, wx.ALIGN_CENTER | wx.ALL, 5)

        self.m_staticText273 = wx.StaticText(self, wx.ID_ANY, u"Получение награды", wx.DefaultPosition, wx.DefaultSize,
                                             0)
        ...
        self.path_center = wx.FilePickerCtrl(self, wx.ID_ANY, wx.EmptyString, u"Select a file", u"*.*",
                                             wx.DefaultPosition, wx.DefaultSize, wx.FLP_DEFAULT_STYLE)
        ...
        self.path_play = wx.FilePickerCtrl(self, wx.ID_ANY, wx.EmptyString, u"Select a file", u"*.*",
                                           wx.DefaultPosition, wx.DefaultSize, wx.FLP_DEFAULT_STYLE)
        path_center_block1.Add(self.path_play, 1, wx.ALIGN_CENTER | wx.ALL, 5)

        self.m_staticText27321 = wx.StaticText(self, wx.ID_ANY, u"Запуск рекламы", wx.DefaultPosition, wx.DefaultSize,
                                               0)
        ...
        self.cat_screen_button = wx.Button(self, wx.ID_ANY, u"Каталог скриншотов", wx.DefaultPosition, wx.DefaultSize,
                                           0)
        dialogs_block.Add(self.cat_screen_button, 0, wx.ALL | wx.EXPAND, 5)

        self.screen_dialog_button = wx.Button(self, wx.ID_ANY, u"Конфигурация экрана", wx.DefaultPosition,
                                              wx.DefaultSize, 0)
        ...
        self.menu = wx.Menu()
        self.reset_screen_setting = wx.MenuItem(self.menu, wx.ID_ANY,
                                                u"Сбросить конфигурацию экрана" + u"\t" + u"ctrl+x", wx.EmptyString,
                                                wx.ITEM_NORMAL)
        self.menu.Append(self.reset_screen_setting)

        self.default_settings = wx.MenuItem(self.menu, wx.ID_ANY, u"Сбросить параметры" + u"\t" + u"ctrl+d",
        ...
        self.screen_dialog_button.Bind(wx.EVT_BUTTON, self.open_screen_dialog)
        self.testing_dialog_button.Bind(wx.EVT_BUTTON, self.open_testing_dialog)
        ...
        self.Bind(wx.EVT_MENU, self.open_log_frame, id=self.OpenLog.GetId())
    ...
    def open_screen_dialog(self, event):
        self.screen_d.ShowModal()
        event.skip()

    def open_testing_dialog(self, event):
        self.testing_d.ShowModal()
        event.skip()

    def open_log_frame(self, event):
    ...
    def infinite_loop(self, event):
        ...
        while self.running:
            ...
            if self.find_close_loop(
                    ...
                    x_rad_min=x_rad_min, x_rad_max=x_rad_max, error_time=error_time, exit_zones=exit_zones,
                    wb_lvl=wb_lvl, bx=bx, by=by,
                ...
                # Считаем, что нашли сундук только если с прошлой итерации остались флаги о нахождении и
                # ВЫХОДА и СУНДУКА
    ...
    def find_close_loop(
            self, menu_path, end_path, end_zone, menu_zone, x_rad_min, x_rad_max, error_time, exit_zones,
            wb_lvl, bx, by, precision, click_back, screen_path, screen_zone
    ):
        ...
        while stopwatch(_now) < error_time and self.running:
            ...
            if find_element(menu_path, *menu_zone, precision=precision, click=False):
                self.set_status(" Успех!", not_down=1)
                return True
        ...
        if stopwatch(_now) >= error_time:
            ...
            self.set_status("Выход не обнаружен! Сохранение проблемного экрана: " + _screen_error, not_down=1)

        return False

    # Цикл должен быть по сути бесконечный, но если долго не будет сундуков, то приложение заснёт, поэтому периодически
    # требуется проверять заново что мы в главном экране и если это не так, то жмем "назад" пока не выйдем
    # в главное меню для продолжения работы,
    # либо уходим в перезагрузку если "назад" не помогает.
    def find_chests_loop(
            self, sleep_time, chest_path, chest_zone, precision, ad_time, menu_path, menu_zone,
        ...
        while not _found:
            ...
            # Ищем золотой сундук, если находим то кликаем Play, засыпаем на заданный отрезок времени и
            # после завершаем функцию
    ...
    def set_status(self, message, sector=0, not_down=0):
        self.statusbar.SetStatusText(message, sector)  # Обновляем текстовое сообщение в статус-баре

        _end = "\n" if not_down == 0 else " "
        self.loger.LOG.SetValue(
            self.loger.LOG.GetValue() + _end + datetime.now().strftime("%H:%M:%S") + " -: " + message)
